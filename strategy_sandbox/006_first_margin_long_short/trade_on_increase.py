...
class IterativeBacktest(IterativeBase):
    ...
    def calculate_pinbar_strategy(self, lookback_bars=100, ma_interval=20, body_size=0.30, extremum_ratio_size=0.35, bar_seq = 3, atr = 1):
        ...
        #Calculate pinbar 
        self.data['rng'] = self.data.close-self.data.open
        ...
        #OPEN POSITIONS
            ...
            if self.increase==bar_seq and (self.data.rng.iloc[bar] > (self.data.ATR.iloc[bar] * atr)):
                if self.position == 0:
            ...
            elif self.increase==(-1)*bar_seq and (self.data.rng.iloc[bar] > (self.data.ATR.iloc[bar] * atr)):
                if self.position == 0:
...
bc = IterativeBacktest("BTCUSDT","2022-01-28","2022-09-28",tf='5m',amount = 1000)
