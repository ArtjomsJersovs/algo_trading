...
class IterativeBacktest(IterativeBase):
    ...
    def calculate_pinbar_strategy(self, lookback_bars=100, ma_interval=20, body_size=0.30, extremum_ratio_size=0.35):
        ...
        #OPEN POSITIONS
            ...
            if around_prev_min_flag.iloc[bar] and ratio_body_flag.iloc[bar] and ratio_high_flag.iloc[bar] and over_atr_flag.iloc[bar]:
                if self.position == 0:
            ...
            elif around_prev_max_flag.iloc[bar] and ratio_body_flag.iloc[bar] and ratio_low_flag.iloc[bar] and over_atr_flag.iloc[bar]:
                if self.position == 0:
...
bc = IterativeBacktest("BTCUSDT","2022-01-01","2022-10-03",tf='1m',amount = 1000)

bc.calculate_pinbar_strategy(body_size=0.20, extremum_ratio_size=0.25)
bc.plot_data()
