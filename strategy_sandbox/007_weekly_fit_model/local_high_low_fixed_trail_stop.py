...
class IterativeBacktest(IterativeBase):
    ...
    def calculate_pinbar_strategy(self, lookback_bars=100, ma_interval=20, tp_coef = 1, sl_coef = 1):
        ...
        #OPEN POSITIONS
            ...
            if breaks_local_low.iloc[bar] and RSI_neutral.iloc[bar]:
                if self.position == 0:
            ...
            elif breaks_local_high.iloc[bar] and RSI_neutral.iloc[bar]:
                if self.position == 0:
...
bc.calculate_pinbar_strategy(lookback_bars=8, ma_interval = 10, tp_coef=1, sl_coef=2)
bc.plot_data()
