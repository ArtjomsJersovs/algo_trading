...
class IterativeBacktest(IterativeBase):
    ...
    def calculate_pinbar_strategy(self, lookback_bars=100, ma_interval=20, body_size=0.30, extremum_ratio_size=0.35, atr_cut = 1, tp_coef = 1, sl_coef = 1):
        #print header
        print(75 * "-")
        ...
        over_atr_flag = self.data['rng'] > (self.data.ATR*3)
...
bc = IterativeBacktest("BTCUSDT","2022-10-15","2022-10-22",tf='1m',amount = 1000)

bc.calculate_pinbar_strategy(body_size=0.3, extremum_ratio_size=0.35, ma_interval = 20, atr_cut = 1, tp_coef=5, sl_coef=1)
bc.plot_data()
bc.data.ATR.head(10)
...
sf.excel_export(bc.data, size=1000)
