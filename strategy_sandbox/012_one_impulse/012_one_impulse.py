...
bc = IterativeBacktest("BTCBUSD","2022-11-29","2022-12-10",tf='1h',amount = 1000)
...
data = sf.get_stored_data_close('BTCBUSD','1h','2020-01-01','2022-12-10')
# Initialize Bollinger Bands Indicator



pd.to_datetime(pd.Timestamp.utcnow().tz_localize(None)).floor('1H')